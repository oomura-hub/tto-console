...
<div class="alert-box">
    ...
    「売ろうとするな、つながろうとせよ」。SNSでは広告感が出た瞬間にスワイプされます。ユーザーの日常に溶け込み、共感や発見を生むことが成功の鍵です。
            ...
            {
                id: "ch1-3", title: "1-3 アルゴリズムという概念", html: `<h2>1-3 アルゴリズムという概念</h2>
<div class="alert-box">
    アルゴリズムとは、プラットフォームが膨大な投稿の中から<b>「どのユーザーに」「どの順番で」</b>届けるかを判断する<b>「自動評価・選別システム」</b>のことです。
</div>

![アルゴリズムの仕組みイメージ](sns_algorithm_concept_1770881337981.png)

<h3>1. なぜアルゴリズムが存在するのか？</h3>
<p>各プラットフォーム（TikTok, Instagram, YouTube等）の目的は、<b>「ユーザーをアプリ内に1秒でも長く留まらせること」</b>です。そのために、ユーザーが飽きないよう、興味・関心に完璧に一致するコンテンツを AI が瞬時にマッチングしています。</p>

<h3>2. 主要3媒体のアルゴリズム特性（2026年最新版）</h3>
<div class="comparison-grid">
    <div class="comp-box comp-success">
        <h4>TikTok：爆発力型</h4>
        <p><b>【評価軸：視聴時間・視聴完了率】</b><br>
        フォロワー数に関わらず、投稿単体の「面白さ」が最優先。AIが「おすすめ欄（FYP）」へ強制的にレコメンド。1つのバズが凄まじい拡散力を生みます。</p>
    </div>
    <div class="comp-box comp-success">
        <h4>Instagram：信頼・発見型</h4>
        <p><b>【評価軸：保存数・外部共有】</b><br>
        フォロワーとの関係の深さ（DM、コメント）と、リールによる新規発見を重要視。2026年現在は「深いエンゲージメント」が露出の鍵。</p>
    </div>
    <div class="comp-box comp-success">
        <h4>YouTube：満足度重視型</h4>
        <p><b>【評価軸：CTR（クリック率）・総再生時間】</b><br>
        検索需要とレコメンドの両軸。満足度（アンケート等）や滞在時間の長さを評価。長尺動画はストック性が高いのが特徴。</p>
    </div>
</div>

<h3>3. 全アルゴリズム共通の「最重要指標」</h3>
<p>どの媒体であっても、以下の3つは<b>「アルゴリズムに評価されるための必須条件」</b>です。</p>
<div class="check-grid">
    <div class="check-item">
        ⏱️ <b>滞在時間の最大化：</b><br>最後まで見られる、あるいは繰り返し見られる投稿かどうか
    </div>
    <div class="check-item">
        🚀 <b>初動のエンゲージメント：</b><br>投稿直後のユーザー反応が良ければ、AIは「良いコンテンツ」と判断し拡散範囲を広げる
    </div>
    <div class="check-item">
        📱 <b>独自性とトレンドの融合：</b><br>見たことがない切り口（独自性）と、今流行っている要素（トレンド）のバランス
    </div>
</div>
...
<div class="tip-box">
    ...
    },
    {
        ...
        sections: [
            {
                id: "ch2-1", title: "2-1 TikTokのアルゴリズム", html: `<h2>2-1 TikTokのアルゴリズム</h2>
<div class="alert-box">
    TikTokのアルゴリズムは、フォロワー数に関係なく<b>「動画単体の面白さ」</b>をAIが正当に評価し、爆発的に拡散させる（レコメンドする）仕組みです。
</div>

<h3>1. アルゴリズムが重視する「加点ポイント」</h3>
<p>アルゴリズムは以下の優先順位であなたの動画を評価しています。</p>
<div class="check-grid">
    <div class="check-item">
        🏆 <b>視聴完了率・再生時間（最優先）：</b><br>
        「最後まで見られたか」「繰り返し見られたか」が最大の加点。SNSは可処分時間の奪い合いです。
    </div>
    <div class="check-item">
        ⭐ <b>保存数・シェア数：</b><br>
        「後で見返したい」「誰かに教えたい」という強い興味の証。保存が多い動画は、さらに広い層へレコメンドされます。
    </div>
    <div class="check-item">
        💬 <b>コメント数（議論）：</b><br>
        コメント欄が盛り上がっている＝滞在時間が伸びるため評価されます。
    </div>
</div>

<h3>2. 拡散のステップ（200回のテスト）</h3>
<div class="flow-container">
    <div class="flow-step"><span><b>テスト配信</b><br>投稿直後、約200~300人のランダムなユーザーに表示</span></div>
    <div class="flow-arrow">↓</div>
    <div class="flow-step"><span><b>初動評価</b><br>その200人の「視聴時間」や「反応」をAIが測定</span></div>
    <div class="flow-arrow">↓</div>
    <div class="flow-step"><span><b>拡散拡大</b><br>評価が基準を超えれば、1000人、1万人と拡散範囲が拡大（おすすめ載り）</span></div>
</div>

<div class="tip-box">
    💡 <b>フォロワー0でもバズる理由：</b><br>
    TikTokは「誰が投稿したか」よりも「目の前のユーザーを足止めしたか」を重視するため、新規アカウントでも初日に100万再生される可能性があります。これがTTOが成立する最大の理由です。
</div>` },
            {
                id: "ch2-2", title: "2-2 ユーザーの行動心理", html: `<h2>2-2 ユーザーの行動心理</h2>
<div class="alert-box">
    TikTokを見ているユーザーの脳は、いわば<b>「スタンバイ（低燃費）モード」</b>です。難しいことは考えたくない、ただ面白いものを浴びたいという心理を理解しましょう。
</div>

<h3>1. 「脳死」スワイプの壁</h3>
<p>ユーザーは次の動画を流すか決めるまで、<b>わずか0.5秒〜1秒</b>しかかけていません。この「スワイプの指を止める」努力が全てです。</p>

<div class="check-grid">
    <div class="check-item">
        ⏱️ <b>冒頭0.5秒の勝負：</b><br>「えっ？」「何これ？」と直感的に思わせるビジュアルが必須。
    </div>
    <div class="check-item">
        🧠 <b>思考コストの最小化：</b><br>難しい漢字や、長い文章は読みません。「パッと見てわかる」ことが正義です。
    </div>
    <div class="check-item">
        😋 <b>本能への訴求：</b><br>食、性、美容、裏ワザ。理屈ではなく「本能的に気になる」テーマが強い。
    </div>
</div>

<h3>2. ユーザーは「検索」ではなく「発見」を求めている</h3>
<div class="comparison-grid">
    <div class="comp-box comp-risk">
        <h4>YouTubeの心理</h4>
        <p>「この情報を知りたい」という能動的な姿勢。多少長くても、有益なら見てくれる。</p>
    </div>
    <div class="comp-box comp-success">
        <h4>TikTokの心理</h4>
        <p>「何か面白いことないかな」という受動的な姿勢。少しでも退屈（無益/不明瞭）と感じた瞬間にスワイプされる。</p>
    </div>
</div>

<div class="tip-box">
    ⚠️ <b>インターン生への教訓：</b><br>
    「自分が伝えたいこと」を語るのではなく、「相手が指を止めてしまうもの」を先に置く。これを<b>「フック」</b>と呼びます。
</div>` },
            {
                id: "ch2-3", title: "2-3 投稿フォーマット", html: `<h2>2-3 投稿フォーマット</h2>
<div class="alert-box">
    TikTokには大きく分けて<b>「画像スライド（カルーセル）」</b>と<b>「動画投稿」</b>の2種類があります。SGTのTTO戦略では、主に「画像スライド」を活用します。
</div>
...
<div class="comparison-grid">
    <div class="comp-box comp-success">
        <h4>画像スライド（推奨）</h4>
        <ul>
            <li><b>【メリット】</b> 量産しやすい、情報密度が高い、保存されやすい、Canvaで制作完結。</li>
            <li><b>【相性】</b> 「○選」「比較」「診断」「手順」など、止まって読ませるコンテンツに最強。</li>
        </ul>
    </div>
    <div class="comp-box comp-success">
        <h4>動画投稿</h4>
        <ul>
            <li><b>【メリット】</b> 感情に訴えやすい、信頼構築が早い、音楽との連動性が高い、CapCut等で編集。</li>
            <li><b>【相性】</b> 「検証」「使用感」「インタビュー」など、動きやリアルさを見せるコンテンツに有効。</li>
        </ul>
    </div>
</div>

<h3>なぜ画像スライドが売れるのか？</h3>
<p>画像スライドは、自分のペースで左右にスワイプできるため、ユーザーの<b>「知りたい部分だけをじっくり見る」</b>という行動にマッチします。結果として滞在時間が伸び、高い売上（CVR）に繋がります。</p>

<div class="tip-box">
    🎨 <b>制作ツール：</b><br>
    画像スライドは全て <b>Canva</b> を使用して作成します。デザインのセンスよりも、「情報の配置」と「文字の読みやすさ」が重要です。
</div>` },
            {
                id: "ch2-4", title: "2-4 TikTok Shop / アフィリエイト", html: `<h2>2-4 TikTok Shop / アフィリエイトの仕組み</h2>
<div class="alert-box">
    TTOの収益源は、動画から<b>「商品を売ること」</b>です。その中心となるのが <b>TikTok Shop</b> と <b>クリエイターアフィリエイト</b> です。
</div>

<h3>1. クリエイターアフィリエイトとは？</h3>
<p>各ブランド（弊社含む）が設定した商品を、自身の動画にタグ付けして紹介し、そこから購入が発生した際に<b>売上の数%〜数十%を成果報酬</b>として受け取る仕組みです。</p>

<h3>2. 収益発生のステップ</h3>
<div class="flow-container">
    <div class="flow-step"><span><b>投稿</b><br>動画/画像に「商品リンク」を紐づけて投稿</span></div>
    <div class="flow-arrow">↓</div>
    <div class="flow-step"><span><b>認知・興味</b><br>ユーザーが動画を見て、商品黄色カートをクリック</span></div>
    <div class="flow-arrow">↓</div>
    <div class="flow-step"><span><b>購入</b><br>TikTokアプリ内で決済完了</span></div>
    <div class="flow-arrow">↓</div>
    <div class="flow-step"><span><b>報酬確定</b><br>弊社に売上が入り、あなたのアカウントに報酬が発生</span></div>
</div>

<div class="comparison-grid">
    <div class="comp-box comp-success comp-full">
        <h4>TTOの強み（利益率）</h4>
        <p>普通の物販や広告運用と違い、<b>「広告費が0円」</b>です。売上のほとんどが利益になるため、たった1本のバズ投稿で数十万円〜百万円以上の利益を出すことも珍しくありません。</p>
    </div>
</div>

<div class="tip-box">
    📈 <b>インターン生の目標：</b><br>
    まずは「自分の投稿から1個売れる体験」を目指しましょう。1個売れる構造がわかれば、あとは再生数を伸ばすだけで収益は桁違いに増えていきます。
</div>` }
        ]
    },
    {
